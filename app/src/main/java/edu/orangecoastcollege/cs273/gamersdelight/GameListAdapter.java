...
public class GameListAdapter extends ArrayAdapter<Game> {
    ...
    public View getView(int pos, View convertView, ViewGroup parent)
    {
        ...
        TextView gameListDescription = (TextView) view.findViewById(R.id.gameListDescriptionTextView);
        ...
        try
        {
            String imageFileName = selectedGame.getImageName();
            InputStream inputStream = am.open(imageFileName);
            Drawable imageDrawable = Drawable.createFromStream(inputStream, imageFileName);
            gameListImageView.setImageDrawable(imageDrawable);
